...
public enum BusinessNetworkError: Error {
  ...
  public static func error(for error: Error) -> BusinessNetworkError {
    if let urlError = error as? URLError {
      return .unexpected(urlError)
    } else if let networkError = error as? BusinessNetworkError {
      return networkError
  ...
  public static func customError(for code: String, message: String) -> BusinessNetworkError {
